...
<!--    </component>-->
    ...
    <span class="action">
      <a class="cloud_title" target="_blank" href="https://www.oracle.com/au/cloud/">
        <a-icon type="cloud" theme="filled" style="font-weight: bold;font-size: 16px; line-height: 16px;" />
      </a>
    </span>
    <span class="action">
      <a target="_blank" href="http://www.jayshenworld.tk/">
